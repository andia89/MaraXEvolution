...
//19109202/1750034/2.50/15/3/Integrated Circuit
...
(library Library_1
	...
	(padStyleDef "r334_294"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 2.94) (shapeHeight 3.34))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	(textStyleDef "Normal"
		(font
	...
	(patternDef "SOP65P640X120-15N" (originalName "SOP65P640X120-15N")
		(multiLayer
			...
			(pad (padNum 15) (padStyleRef r334_294) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "TPS1HTC30AQPWPRQ1" (originalName "TPS1HTC30AQPWPRQ1")
		...
		(pin (pinNum 8) (pt 700 mils -1600 mils) (rotation 90) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 725 mils -1370 mils) (rotation 90]) (justify "Left") (textStyleRef "Normal"))
		))
	...
	(compDef "TPS1HTC30AQPWPRQ1" (originalName "TPS1HTC30AQPWPRQ1") (compHeader (numPins 15) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "DIAG_EN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "4" (pinName "__FAULT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "5" (pinName "LATCH") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "6" (pinName "SNS") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "7" (pinName "ILIM") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "15" (pinName "THERMAL PAD") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "14" (pinName "VS_3") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "13" (pinName "VS_2") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "12" (pinName "VS_1") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "11" (pinName "NC") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "VOUT_3") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "9" (pinName "VOUT_2") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "8" (pinName "VOUT_1") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Power))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS1HTC30AQPWPRQ1"))
		...
		(attr "Mouser Part Number" "595-TPS1HTC30AQPWPQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS1HTC30AQPWPRQ1?qs=ST9lo4GX8V3KvUd2Q%2FnDqA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS1HTC30AQPWPRQ1")
		(attr "Description" "Power Switch ICs - Power Distribution Automotive, 60-V, 6-A, 30-mO, one-channel smart high-side switch with adjustable current limit 14-HTSSOP -40 to 125")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tps1htc30-q1.pdf?ts=1723072122521")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "TPS1HTC30AQPWPRQ1.stp")
